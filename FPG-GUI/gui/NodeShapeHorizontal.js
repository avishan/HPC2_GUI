...
//mostatil Toosi
ChannelShapeHorizontal = draw2d.shape.basic.Label.extend({
	NAME: "ChannelShapeHorizontal",
...
//White mostatil
FPGAShapeHorizontal = draw2d.shape.layout.HorizontalLayout.extend({
	NAME: "FPGAShapeHorizontal",
    ...
    addChannel : function() {
        // addChannel : function(fpgashapeHorizontal, string_channel) {
...
//blue mostatil
NodeShapeHorizontal = draw2d.shape.layout.HorizontalLayout.extend({

	NAME: "NodeShapeHorizontal",
    ...
    addFPGA : function(string_acl) {
        var fpgalabel = new FPGAShapeHorizontal();
